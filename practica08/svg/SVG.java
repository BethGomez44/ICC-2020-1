...
public class SVG {
    ...
    public void agregarLinea(Linea linea) {
        String l = "<line x1=\"" + linea.getP1().getX() + "\"" +
                    " y1=\"" + (altura - linea.getP1().getY()) + "\"" +
                    " x2=\"" + linea.getP2().getX() + "\"" +
                    " y2=\"" + (altura - linea.getP2().getY()) + "\"" +
                    " style=\"" + "stroke: black; stroke-width: 1; fill: none" + "\"" + "/>";
        concatenar(l); //Implementar
    }
    ...
    public void agregarTriangulo(Triangulo triangulo) {
        ...
        agregarLinea(new Linea(triangulo.getC(),triangulo.getA()));
        // Implementar
    }
