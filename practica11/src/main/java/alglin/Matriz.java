...
public class Matriz {
     ...
     * @param i    la fila donde se insertará dato
     * @param j    la columna donde se insertará dato
     */
    ...
    /**
     * Suma esta matriz con otra. Regresa null si las matrices no tienen las mismas
     * dimensiones.
     *
     * @param otra la otra matriz con la cual se sumará esta
     * @return una matriz nueva que resulta de sumar esta con otra
     */
     ...
     * @return una matriz nueva que resulta de multiplicar esta por c
     */
     ...
     * &nbsp;5.0 7.0 2.0 4.0"
     *
     * @return la representación en String de esta matriz
     */
    @Override
    ...
    /*
     * Regresa true si y sólo si obj es una instancia de {@link alglin.Matriz} y las
     * matrices son iguales entrada por entrada.
     *
     * @param obj el objeto a comparar
     * 
     * @return true si this y obj son iguales entrada por entrada
     */
    @Override
